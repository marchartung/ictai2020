...
set datafile separator ","
plot  "std_percent_proof.csv" u 1:($2+$3+$4) title "verify LRAT" w filledcurves x1, "std_percent_proof.csv" u 1:($2+$3) title "verify DRAT" w filledcurves x1, "std_percent_proof.csv" u 1:($2) title "solve time" w filledcurves x1
